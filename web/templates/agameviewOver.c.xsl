    ...
    <div class="w3-third">
      ...
      <div class="w3-white w3-text-grey w3-card-4">
        <div class="w3-display-container">
          <img src="../images/Overwatch.jpg" style="width:100%" alt="Avatar" />
    ...
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        ...
        <div class="w3-container">
            ...
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>Alguem de um ramo qualquer</h6>
            <hr></hr>
        ...
        <div class="w3-container">
          ...
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>Jun 2012 - Mar 2018</h6>
          <br></br>
        </div>
        <div class="w3-container">
          <h5 class="w3-opacity" ><b>Pagina Wiki</b></h5>
          <h6 class="w3-text-teal" ><i class="fa fa-calendar fa-fw w3-margin-right"></i><a href="https://pt.wikipedia.org/wiki/Overwatch">Visitar</a></h6>
          <br></br>
        </div>
      </div>
